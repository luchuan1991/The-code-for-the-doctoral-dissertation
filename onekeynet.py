...
# 输入文件路径
input_file = r"F:\graduate\tongue\xinxueguan1397\dlfeatures\data_vgg11_xuerad\data_vgg11_xuerad.csv"
# 输出文件路径
output_file = r"F:\graduate\tongue\xinxueguan1397\dlfeatures\data_vgg11_xuerad\data_vgg11_xuerad_norm.csv"
